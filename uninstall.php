...
foreach ( [ 'hgsd_reviews_settings', 'hgsd_reviews_cache', 'hgsd_conflict_settings', 'hgsd_ai_settings', 'hgsd_db_version', 'hgsd_index_pointer', 'hgsd_indexed_at', 'hgsd_gsc_settings', 'hgsd_tips_dismissed' ] as $hgsd_option ) {
